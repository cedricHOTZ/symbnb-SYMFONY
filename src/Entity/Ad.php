 ...
 * Permet de ne pas avoir de doublon d'annonce
 * @UniqueEntity(
 * fields={"title"},
...
class Ad
{
     ...
     * @Assert\Length(min=3,max=255,minMessage="Le titre doit faire plus de 10 caractères",
    ...
    /**
     * Permet d'initialiser le slug sans le renseigner
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * @return void
     */
    ...
    public function getCommentFromAuthor(User $author){
     ...
     //function pour afficher la moyenne globale des notes pour cette annonce
