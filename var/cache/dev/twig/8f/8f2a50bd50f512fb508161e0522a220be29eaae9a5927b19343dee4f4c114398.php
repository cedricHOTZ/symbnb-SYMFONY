...
class __TwigTemplate_8a00a11401b13569ca225b60d988fd7b2021108d568dd084f567dda3f51be4fc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<button type=\"button\" id=\"add-image\" class=\"btn btn-primary\"><i class=\"fas fa-plus\">Ajouter une image</i></button>
</div>
";
        ...
        <div class=\"col-10\">
            <div class=\"row\">
                <div class=\"col\">
                    ";
        // line 21
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), "url", [], "any", false, false, false, 21), 'widget');
        echo "
                    ";
        // line 22
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 22, $this->source); })()), "url", [], "any", false, false, false, 22), 'errors');
        echo "
                </div>
                <div class=\"col\">
                    ";
        // line 25
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 25, $this->source); })()), "caption", [], "any", false, false, false, 25), 'widget');
        echo "
                    ";
        // line 26
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 26, $this->source); })()), "caption", [], "any", false, false, false, 26), 'errors');
        echo "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return array (  160 => 31,  152 => 26,  148 => 25,  142 => 22,  138 => 21,  129 => 16,  119 => 15,  106 => 12,  96 => 11,  80 => 4,  76 => 2,  66 => 1,  56 => 15,  53 => 14,  51 => 11,  48 => 10,  46 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% block _ajouter_annonce_images_widget %}
...
{% endblock %}
", "ad/_collection.html.twig", "/Users/macbook/Desktop/symfony-udemy/templates/ad/_collection.html.twig");
    }
}
