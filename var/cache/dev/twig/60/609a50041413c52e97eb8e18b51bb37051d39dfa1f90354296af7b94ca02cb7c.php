...
class __TwigTemplate_36db9bab428c64975e0d65b867e14f1ea2e2aa9008637fe6f7a5ba98802fbfee extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 9
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 9, $this->source); })()), "message", [], "any", false, false, false, 9), "html", null, true);
        echo "
<a href=\"";
        // line 10
...
{% block title %} Vous n'avez pas le droit d'acceder à cette page{% endblock %}
...
{% endblock %}", "@Twig/Exception/error403.html.twig", "/Users/macbook/Desktop/symfony-udemy/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
