...
class __TwigTemplate_b277a8bb48877122dc3481666601c7cb3a1c635840c4edb15069c022022b1cd0 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 4
            echo "    ";
            if (($context["i"] <= (isset($context["rating"]) || array_key_exists("rating", $context) ? $context["rating"] : (function () { throw new RuntimeError('Variable "rating" does not exist.', 4, $this->source); })()))) {
                // line 5
    ...
    {
        return array (  69 => 10,  63 => 9,  59 => 7,  55 => 5,  52 => 4,  48 => 3,  45 => 2,  43 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("  {# afficha des étoiles en fonction des notes #}
  <span class=\"rating\">
    {% for i in 1..5 %}
    {% if i <= rating %}
    ...
    </span>", "partials/rating.html.twig", "/Users/macbook/Desktop/symfony-udemy/templates/partials/rating.html.twig");
    }
}
